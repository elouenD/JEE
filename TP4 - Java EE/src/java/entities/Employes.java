...
public class Employes implements Serializable {
    ...
    public Employes(Integer id, String nom, String prenom, String teldom, String telport, String telpro, String adresse, int codepostal, String ville, String email) {
        this.id = id;
        this.nom = nom;
        this.prenom = prenom;
        this.teldom = teldom;
    ...
    public Employes( String nom, String prenom, String teldom, String telport, String telpro, String adresse, int codepostal, String ville, String email) {
        this.nom = nom;
        this.prenom = prenom;
        this.teldom = teldom;
        this.telport = telport;
    ...
    public String toString() {
        return "entities.Employes[ id=" + id + " ]";
    }
